...
export class Sudoku {
    ...
    getCandidatesMap(board: string): any[] {
    ...
    assign(candidates: {}, square: number, val: number): {} | boolean {
    ...
    eliminate(candidates: {}, square: number, val: number): {} | boolean {
    ...
    getSquareValsMap (board: string): any[] {
